...
if st.session_state.servico is None:
    ...
    with col1:
        ...
        if st.button("🏢 SAC NDI", use_container_width=True, height=220):
    ...
    with col2:
        st.markdown('<div class="hub-card">', unsafe_allow_html=True)
        if st.button("🏦 SAC PPO", use_container_width=True, height=220):
    ...
    with col3:
        st.markdown('<div class="hub-card">', unsafe_allow_html=True)
        if st.button("🏥 SAC HAPVIDA", use_container_width=True, height=220):
